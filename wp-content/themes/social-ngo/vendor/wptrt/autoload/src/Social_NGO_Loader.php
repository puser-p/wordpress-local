...
class Social_NGO_Loader {
	 ...
	 * @return void
	 */
	public function social_ngo_add( $prefix, $paths ) {
	 ...
	 * @return void
	 */
	public function social_ngo_remove( $prefix, $path = '' ) {
	 ...
	 * @return bool
	 */
	public function social_ngo_has( $prefix, $path = '' ) {
		if ( $path ) {
	 ...
	 * @return void
	 */
	public function social_ngo_register() {

		if ( $this->loaders ) {

			spl_autoload_register( function( $class ) {

				$this->social_ngo_load( $class );
			}, true, true );
		}
	}
	/**
	 ...
	 * @return void
	 */
	protected function social_ngo_load( $class ) {
